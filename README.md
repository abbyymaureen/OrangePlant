...
end up locking numerous threads (this would not be a correct mutex implementation). I ended up finding a medium article
with very helpful documentation to guide one through the proper locking process.
